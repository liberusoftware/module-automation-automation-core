# Automation: Automation Core Core Module

> This package is the authoritative, provider-neutral implementation of Automation Core. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-automation-automation-core?sort=semver)](https://github.com/liberusoftware/module-automation-automation-core/releases/latest) [![Tests](https://github.com/liberusoftware/module-automation-automation-core/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-automation-automation-core/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-automation-automation-core
```
...
<a href="https://github.com/liberusoftware/module-automation-automation-core/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-automation-automation-core" alt="Contributors to liberusoftware/module-automation-automation-core">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-automation-automation-core/graphs/contributors).
